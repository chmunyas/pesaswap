...
return [
    ...
    "tickets"                    => "Tickets",
    "tickets_desc"               => "Sell event, scenic, cinema and transport tickets via QR codes.",
    "tickets_redeem"             => "Redeem Tickets",
    "tickets_redeem_desc"        => "Scan and redeem ticket QR codes.",
    "timeclocks"                 => "",
